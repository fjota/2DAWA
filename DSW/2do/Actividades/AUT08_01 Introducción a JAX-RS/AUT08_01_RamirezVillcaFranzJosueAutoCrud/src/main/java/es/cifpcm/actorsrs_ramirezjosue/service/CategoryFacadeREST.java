...
import es.cifpcm.actorsrs_ramirezjosue.model.Category;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.category")
public class CategoryFacadeREST extends AbstractFacade<Category> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Byte id, Category entity) {
    super.edit(entity);
  }
  ...
  public Category find(@PathParam("id") Byte id) {
