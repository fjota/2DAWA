...
import es.cifpcm.actorsrs_ramirezjosue.model.City;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.city")
public class CityFacadeREST extends AbstractFacade<City> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Short id, City entity) {
    super.edit(entity);
  }
  ...
  public City find(@PathParam("id") Short id) {
