...
import es.cifpcm.actorsrs_ramirezjosue.model.Staff;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.staff")
public class StaffFacadeREST extends AbstractFacade<Staff> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Byte id, Staff entity) {
    super.edit(entity);
  }
  ...
  public Staff find(@PathParam("id") Byte id) {
