...
import es.cifpcm.actorsrs_ramirezjosue.model.Country;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.country")
public class CountryFacadeREST extends AbstractFacade<Country> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Short id, Country entity) {
    super.edit(entity);
  }
  ...
  public Country find(@PathParam("id") Short id) {
