...
import es.cifpcm.saklilaautorestweb.FilmCategory;
import es.cifpcm.saklilaautorestweb.FilmCategoryPK;
 ...
 */
@Stateless
@Path("es.cifpcm.saklilaautorestweb.filmcategory")
public class FilmCategoryFacadeREST extends AbstractFacade<FilmCategory> {
  ...
  private FilmCategoryPK getPrimaryKey(PathSegment pathSegment) {
    /*
     ...
     */
    es.cifpcm.saklilaautorestweb.FilmCategoryPK key = new es.cifpcm.saklilaautorestweb.FilmCategoryPK();
    ...
    if (categoryId != null && !categoryId.isEmpty()) {
      key.setCategoryId(new java.lang.Short(categoryId.get(0)));
    }
    return key;
  }
  ...
  public void remove(@PathParam("id") PathSegment id) {
    es.cifpcm.saklilaautorestweb.FilmCategoryPK key = getPrimaryKey(id);
