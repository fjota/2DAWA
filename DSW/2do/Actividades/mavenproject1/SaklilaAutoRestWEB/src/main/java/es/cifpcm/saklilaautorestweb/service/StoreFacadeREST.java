...
import es.cifpcm.saklilaautorestweb.Store;
 ...
 */
@Stateless
@Path("es.cifpcm.saklilaautorestweb.store")
public class StoreFacadeREST extends AbstractFacade<Store> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Short id, Store entity) {
    super.edit(entity);
  }
  ...
  public Store find(@PathParam("id") Short id) {
