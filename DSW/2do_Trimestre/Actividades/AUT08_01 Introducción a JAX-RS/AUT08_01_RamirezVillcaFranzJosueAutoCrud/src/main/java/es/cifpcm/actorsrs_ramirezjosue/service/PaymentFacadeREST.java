...
import es.cifpcm.actorsrs_ramirezjosue.model.Payment;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.payment")
public class PaymentFacadeREST extends AbstractFacade<Payment> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Short id, Payment entity) {
    super.edit(entity);
  }
  ...
  public Payment find(@PathParam("id") Short id) {
