...
import es.cifpcm.actorsrs_ramirezjosue.model.Store;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.store")
public class StoreFacadeREST extends AbstractFacade<Store> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Byte id, Store entity) {
    super.edit(entity);
  }
  ...
  public Store find(@PathParam("id") Byte id) {
