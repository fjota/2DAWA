...
import es.cifpcm.actorsrs_ramirezjosue.model.FilmActor;
import es.cifpcm.actorsrs_ramirezjosue.model.FilmActorId;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.filmactor")
public class FilmActorFacadeREST extends AbstractFacade<FilmActor> {
  ...
  private FilmActorId getPrimaryKey(PathSegment pathSegment) {
    /*
     ...
     */
    es.cifpcm.actorsrs_ramirezjosue.model.FilmActorId key = new es.cifpcm.actorsrs_ramirezjosue.model.FilmActorId();
  ...
  public void remove(@PathParam("id") PathSegment id) {
    es.cifpcm.actorsrs_ramirezjosue.model.FilmActorId key = getPrimaryKey(id);
