...
import es.cifpcm.actorsrs_ramirezjosue.model.Address;
 ...
 */
@Stateless
@Path("es.cifpcm.actorsrs_ramirezjosue.model.address")
public class AddressFacadeREST extends AbstractFacade<Address> {
  ...
  @Path("{id}")
  @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
  public void edit(@PathParam("id") Short id, Address entity) {
    super.edit(entity);
  }
  ...
  public Address find(@PathParam("id") Short id) {
